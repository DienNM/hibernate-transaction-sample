 ...
 * @author dien.nguyen
 */
public class ReadCommittedIsolationTest extends TestCase {
    
    public void testReadUncommittedIsolation() {
        final String  config = "/config/mysql-hibernate-read-committed-isolation.cfg.xml";
